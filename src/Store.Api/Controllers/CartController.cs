...
public class CartController : BaseController<Cart>
{
    ...
    private readonly IValidator<CartRequest> _cartValidator;
    private readonly IValidator<ItemRequest> _itemValidator;
    ...
    {
        var validationResult = await _itemValidator.ValidateAsync(request, cancellationToken);
